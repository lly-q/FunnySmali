...
.method public constructor <init>(Landroid/content/Context;Ldagger/Lazy;Ldagger/Lazy;Lcom/android/systemui/statusbar/notification/NotificationEntryManager;Lcom/android/systemui/statusbar/MediaArtworkProcessor;Lcom/android/systemui/statusbar/phone/KeyguardBypassController;)V
    ...
    const-string p2, "lineagesecure:lockscreen_media_metadata"
...
.method private finishUpdateMediaMetaData(ZZLandroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v10, v3}, Lcom/android/systemui/colorextraction/SysuiColorExtractor;->setHasMediaArtwork(Z)V

    .line 600
    iget-object v10, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mScrimController:Lcom/android/systemui/statusbar/phone/ScrimController;

    if-eqz v10, :cond_8

    .line 601
    invoke-virtual {v10, v9}, Lcom/android/systemui/statusbar/phone/ScrimController;->setHasBackdrop(Z)V

    .line 604
    :cond_8
    iget-object v10, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    if-eqz v10, :cond_a

    invoke-virtual {v10}, Lcom/android/systemui/statusbar/phone/StatusBar;->getVisualizer()Lcom/android/systemui/statusbar/VisualizerView;
    ...
    .line 607
    iget-object v3, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {v3}, Lcom/android/systemui/statusbar/phone/StatusBar;->getVisualizer()Lcom/android/systemui/statusbar/VisualizerView;
    ...
    invoke-virtual {v3, v5}, Lcom/android/systemui/statusbar/VisualizerView;->setBitmap(Landroid/graphics/Bitmap;)V
    ...
    .line 629
    invoke-virtual {v7, p3}, Lcom/android/systemui/statusbar/phone/StatusBarWindowController;->setBackdropShowing(Z)V
...
.method public addCallback(Lcom/android/systemui/statusbar/phone/StatusBar;)V
    ...
    .line 240
    iput-object p1, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method public synthetic lambda$setMediaPlaying$0$NotificationMediaManager(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    .locals 6

    .line 490
    iget-object v0, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;
...
.method public onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "lineagesecure:lockscreen_media_metadata"
    ...
    .line 247
    invoke-direct {p0, p2, p1}, Lcom/android/systemui/statusbar/NotificationMediaManager;->dispatchUpdateMediaMetaData(ZZ)V
...
.method public setMediaPlaying()V
    .locals 6
    ...
    iget v0, v0, Lcom/android/systemui/statusbar/phone/StatusBar;->mTickerEnabled:I
    ...
    new-instance v1, Lcom/android/systemui/statusbar/-$$Lambda$NotificationMediaManager$_VN18JXXgq9yNq3hLYHWxRQi2qE;

    invoke-direct {v1, p0, v4}, Lcom/android/systemui/statusbar/-$$Lambda$NotificationMediaManager$_VN18JXXgq9yNq3hLYHWxRQi2qE;-><init>(Lcom/android/systemui/statusbar/NotificationMediaManager;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/StatusBar;->getVisualizer()Lcom/android/systemui/statusbar/VisualizerView;
    ...
    .line 498
    iget-object p0, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/StatusBar;->getVisualizer()Lcom/android/systemui/statusbar/VisualizerView;

    move-result-object p0

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/VisualizerView;->setPlaying(Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/VisualizerView;->setPlaying(Z)V

    .line 504
    :cond_4
    iget-object p0, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/StatusBar;->resetTrackInfo()V
...
.method public updateMediaMetaData(ZZ)V
    ...
    .line 515
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/NotificationMediaManager;->setMediaPlaying()V
